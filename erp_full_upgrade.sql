...
-- Nouvelles policies (lecture publique)
...
-- ============================================================
-- PARTIE 3 : STORAGE BUCKET "vehicles" + POLICIES
-- ============================================================
...
CREATE POLICY "Public Read Vehicles Storage"
ON storage.objects FOR SELECT
USING (bucket_id = 'vehicles');

CREATE POLICY "Public Upload Vehicles Storage"
ON storage.objects FOR INSERT
WITH CHECK (bucket_id = 'vehicles');

CREATE POLICY "Public Update Vehicles Storage"
ON storage.objects FOR UPDATE
USING (bucket_id = 'vehicles');

CREATE POLICY "Public Delete Vehicles Storage"
