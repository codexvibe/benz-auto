      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-6 animate-slide-up">
          ...
          <div className="flex gap-4">
            <a
              href="https://www.instagram.com/benzautodz/"
              target="_blank"
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <p className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Chargement des Reels...</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {videos.map((video, index) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group cursor-pointer relative rounded-3xl overflow-hidden bg-surface transition-all duration-700 hover:-translate-y-4 hover:shadow-[0_20px_50px_rgba(255,255,255,0.05)] animate-slide-up block"
                ...
                <div className="relative aspect-4/5 md:aspect-3/4 overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-8 z-10">
                    <div className="flex items-center gap-3 text-[10px] text-slate-400 mb-4 uppercase tracking-[0.2em] font-bold">
                      <span>{video.views} interactions</span>
                      <span className="w-1 h-1 rounded-full bg-white/50" />
                      <span>Instagram</span>
                    </div>
                    <h3 className="text-2xl font-bold text-white group-hover:text-glow-chrome transition-all duration-500 leading-tight line-clamp-2">
                      {video.title}
                    </h3>
                  </div>
                </div>
