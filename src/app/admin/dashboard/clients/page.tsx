...
export default function CRMClientsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#05070A] text-slate-200 flex flex-col xl:flex-row p-4 md:p-6 gap-4 md:gap-6 font-sans selection:bg-[#38BDF8]/30 overflow-hidden">
      <Sidebar onLogout={handleLogout} />

      <main className="flex-grow flex flex-col min-w-0 h-[calc(100vh-3rem)]">
        {/* Header */}
        <header className="min-h-28 py-6 md:py-0 bg-[#0F172A]/40 backdrop-blur-3xl border border-white/5 rounded-[2.5rem] mb-6 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0 px-6 md:px-10 shadow-xl relative shrink-0">
